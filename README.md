...
This project showcases practical SQL skills and techniques commonly used by data analysts to explore, clean, and analyze retail sales data. 
It includes creating a retail sales database, performing exploratory data analysis (EDA), and answering key business questions using SQL queries. 
The project is perfect for beginners in data analysis who want to strengthen their foundational SQL knowledge.
...
```
5. **Write an sql query to find all transaction where the total-sale is greater than 1000**
```sql
SELECT *
FROM retail_sales
